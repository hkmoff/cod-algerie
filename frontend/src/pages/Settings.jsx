  ...
  return (
    <div className="min-h-screen px-4 py-6 max-w-2xl mx-auto">
      ...
      <div className="bg-surface rounded-card p-5 flex flex-col gap-5">
        ...
        {saveError && (
          <p className="text-xs text-red-400 break-all">Erreur : {saveError}</p>
        )}
        {saved && !saveError && (
          <p className="text-xs text-green-400">Enregistré — recharge la page produit pour voir le résultat.</p>
        )}
      </div>
    </div>
  );
